...
class Program
{
    static void Main()
    {
        ...
        {
            Console.WriteLine("\nMenu:");
            Console.WriteLine("1. Check if the number is a Palindrome");
            Console.WriteLine("2. Calculate the sum of digits of the number");
            Console.WriteLine("3. Calculate the square root of the number");
